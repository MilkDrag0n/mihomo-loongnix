...
func TestIPCAuthorizationClassifiesSensitiveEndpoints(t *testing.T) {
	requests := []struct {
		...
		{http.MethodPost, "/api/v1/mihomo/versions/1.19.25?action=download", true},
		{http.MethodDelete, "/api/v1/mihomo/versions/1.19.25", true},
		{http.MethodPost, "/api/v1/mihomo/versions/refresh", true},
		{http.MethodGet, "/api/v1/mihomo/upgrade/progress", false},
		{http.MethodGet, "/api/v1/mihomo/versions", false},
